import { adBenefits } from "@/content/advertising"

export function AdBenefitsSection() {
  return (
    <section id="publicidad-beneficios" className="relative px-6 py-24 lg:py-32">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
          Un canal de publicidad exterior de bajo costo que trabaja mientras el tráiler opera
        </p>
